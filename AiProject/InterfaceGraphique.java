...
public class InterfaceGraphique {
	...
	public Button initialisation, backTracking, forwardChecking , fileLoader,SimulatedAnnealing ; 
...
//      Top menu
		...
		topMenu.getChildren().addAll(initialisation,backTracking,forwardChecking,SimulatedAnnealing,fileLoader);
